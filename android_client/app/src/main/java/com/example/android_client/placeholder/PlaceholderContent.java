package com.example.android_client.placeholder;
...
public class PlaceholderContent {
    ...
    private static Task createPlaceholderItem(int position) {
        return new Task("task_id " + Integer.toString(position), "a", "b", "c");
    }
